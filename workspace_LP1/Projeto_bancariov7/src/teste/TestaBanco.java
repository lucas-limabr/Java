...
public class TestaBanco {
	public static void main(String[] args) {
		...
		if (banco1.getConta("2024-4") != null) {
			banco1.imprime(banco1.getConta("2024-4"));
		...
		if (banco2.getConta("2024-6") != null) {
			banco2.imprime(banco2.getConta("2024-6"));
		} else {
		...
		System.out.println("Dados do banco 2 alterados na cópia do array");
		for(Conta conta : banco2.getListaContas()) {
			banco2.imprime(conta);
		}
	}
