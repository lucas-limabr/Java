...
public abstract class Conta {
	...
	public Conta(Clientes cliente, double saldo) {
		...
		this.saldo = saldo;
		Ranking.categorizar(cliente.getCodigo(), saldo);
	}
	...
	// métodos
	public String consultarCategoria(Integer codigo) {
		return Ranking.getCategoria(codigo);
	}

	public static String listarClientesCategorias() {

		String formatacao = "";

		for (Integer item : Ranking.getKeys()) {
			formatacao += "\nCódigo do cliente: " + item + "\nCategoria: " + 
		Ranking.getCategoria(item)+"\n";
		}
