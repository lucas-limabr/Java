...
public class TestaBanco {
	public static void main(String[] args) {
		...
		for (Conta conta : banco1.listaContas) {
			if (conta != null) {
		...
		for (Conta conta : banco2.listaContas) {
			if (conta != null) {
		...
		//fazendo uma cópia do array e alterando dados
		Conta[] listaContas_copy = banco1.getlistaContas();
		
		for (Conta conta : listaContas_copy) {
			if (conta != null) {
				conta.numero = 1000;
			}
		}
		
		System.out.println("Exibindo as contas do banco 1 modificadas pela cópia");
